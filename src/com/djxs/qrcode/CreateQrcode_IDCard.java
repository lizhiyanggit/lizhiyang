...
public class CreateQrcode_IDCard {
	public static void main(String[] args) throws IOException {
		...
		String str="BEGIN:VCARD\n"+
                   "PHOTO;VALUE=uir:https://mimg.127.net/m/lb/img/leftNavBottom/373/0/promPic.png\n" +
                   "FN:姓名:李志洋\n"+
                   "TITLE:河北科技师范学院学生\n"+
                   "ADR;WORK:;;秦皇岛海港区西港镇河北大街西段360号\n"+
                   "TEL;CELL,VOICE:1234567\n"+
                   "TEL;WORK,VOICE:7654321\r\n"+
                   "URL;WORK:http://www.csdn.com\n"+
                   "EMAIL;INTERNET,HOME:我最六邮箱@qq.com\n"+
                   "END:VCARD";//二维码扫出来的内容
        //得到一个二维数组
